...
// TODO: BULLETS DMG AND GOING UP THE SCREEN && MORE COMPANIONS && FILE READER && HEALTH FOR ENEMIES
...
public class GameLoop extends Application {
        ...
        if ( singlePlayer ) {
            ...
            try {
                player = new Character(
                        ...
                        new Dimension(30),
                        new Movement(0, 0, 5),
                        new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\"+ name +".png")),
                        0,
                        root,
                        keyboard);
    ...
    private void createCompanions() {//companion instances being created
        ...
        try {
            companion = new Companion(
                    ...
                    new Dimension(15),
                    new Movement(0, 0, 5),
                    new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\"+ nameLeft +".png")),
                    0,
                    root,
                    keyboard);
            ...
            companion2 = new Companion(
                    ...
                    new Dimension(15),
                    new Movement(0, 0, 5),
                    new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\"+ nameRight +".png")),
                    0,
                    root,
                    keyboard);
            ...
            if (randomBuff < 1) {
                try {
                    Coin coin = new Coin(
                            ...
                            new Dimension(10),
                            new Movement(1, 1, 1),
                            new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\coin.png")),
                            root);
                ...
                if (!spawnedMF)
                {
                    ...
                    try {
                        mayfest = new Mayfest(
                                ...
                                new Dimension(20),
                                new Movement(1, 1, 1),
                                new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\mayfest.png")),
                                root
                        );
                ...
                if (!spawnedSD) {
                    ...
                    try {
                        shield = new Shield(
                                ...
                                new Dimension(20),
                                new Movement(1, 1, 1),
                                new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\shield.png")),
                                root
                        );
                        shield.renderobject();
                ...
                if (!spawnedAN)
                {
                    ...
                    try {
                        allNighter = new AllNighter(
                                ...
                                new Dimension(20),
                                new Movement(1, 1, 1),
                                new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\allNighter.png")),
                                root
                        );
                ...
                if (!spawnedRM)
                {
                    ...
                    try {
                        rageMode = new RageMode(
                                ...
                                new Dimension(20),
                                new Movement(1, 1, 1),
                                new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\rageMode.png")),
                                root
                        );
            ...
            if (enemyType == 0) {
                ...
                if (obstacleCounter != numberOfObstacles && enemyObs == null) {
                    ...
                    enemyObs = new Obstacle(
                            ...
                            new Dimension(15),
                            new Movement(1, 0, 1),
                            new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\deadline.png")),
                            root
                    );
                ...
                if ( assistantCounter != numberOfTA  ) {
                    TA enemyTA = new TA(
                            ...
                            new Dimension(25),
                            new Movement(1, 0, 0),
                            new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\ercument.png")),
                            root
                    );
                ...
                if ( professorCounter != numberOfBosses && enemyBoss == null ) {
                    enemyBoss = new Professor(
                            ...
                            new Image(new FileInputStream("C:\\Users\\MONSTER\\IdeaProjects\\src\\resources\\ugur.png")),
                            root
    ...
    private static int calculateCoins(){
        coins = coins + Shop.getCoinsShop();
        return coins;
    }

    /*private static int calculateHighscore(){
